...
from vai.dpuv1.rt.xdnn_opt import CPUTransform, HWEmuTransform, FPGATransform
try:
...
class CaffexdnnRT(_xdnnRT):
    def __init__ (self, args, compilerFunc=CaffeFrontend, **kwargs):
        self.inputs = None
        self.outputs = None
        super(CaffexdnnRT, self).__init__(args, compilerFunc, **kwargs)
